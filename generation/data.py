...
import music as mm
from music import chords_lib
from music import drums_encoder_decoder
from music import sequences_lib
...
#padding note sequence to fix length
...
# extract a certain instrument note sequence 
...
class GrooveConverter(BaseNoteSequenceConverter):
  ...
  def _to_tensors(self, note_sequence):
    ...
    def _extract_windows(tensor, window_size, hop_size):
      ...
      # if tensor.shape[0]<window_size:
      #   tensor=np.pad(tensor,((0,window_size-tensor.shape[0]),(0,0)),'constant',constant_values=(0,0))
