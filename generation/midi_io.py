...
if __name__=="__main__":
  sequence=midi_file_to_note_sequence(r"C:\Users\MeteorRain\Desktop\7_pop-groove7-4.mid")
  ...
  x=data_converter.to_tensors(note_sequence=sequence)
  for xslice in x.outputs:
    print(xslice.shape)
    j=1
    for i in xslice:
      print(i[9:])
      ...
      if j==50:
        break
    break
  np.savetxt('C:\\Users\\MeteorRain\\Desktop\\test.txt',np.array(x.outputs[0][:,9:]),fmt="%f")
  print(type(x.outputs[0]))
  seq=data_converter._to_notesequences(x.outputs)
  # print(seq)
  # for i,ns in enumerate(seq):
  #   note_sequence_to_midi_file(ns,"C:\\Users\\MeteorRain\\Desktop\\t%d.mid"%(i))
  # print(sequence)
