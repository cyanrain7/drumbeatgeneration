...
Input wrappers for converting MusicXML into tensorflow.NoteSequence.
"""

from music import musicxml_parser
from music.protobuf import music_pb2
...
def musicxml_to_sequence_proto(musicxml_document):
  """Convert MusicXML file contents to a tensorflow.NoteSequence proto.

  Converts a MusicXML file encoded as a string into a
  tensorflow.NoteSequence proto.
  ...
  Returns:
    A tensorflow.NoteSequence proto.
...
def musicxml_file_to_sequence_proto(musicxml_file):
  """Converts a MusicXML file to a tensorflow.NoteSequence proto.

  Args:
    musicxml_file: A string path to a MusicXML file.

  Returns:
    A tensorflow.Sequence proto.
