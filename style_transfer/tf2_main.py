...
parser.add_argument('--time_step', dest='time_step', type=int, default=32, help='time step of pianoroll')
parser.add_argument('--pitch_range', dest='pitch_range', type=int, default=12, help='pitch range of pianoroll')
...
parser.add_argument('--sigma_d', dest='sigma_d', type=float, default=1, help='sigma of gaussian noise of discriminators')
...
parser.add_argument('--test_model_dir',  dest='test_model_dir',  default='./checkpoint', help='models for testing')
